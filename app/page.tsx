    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Seamless integrations when you need them.
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-gray-50 rounded-xl p-8 shadow-md text-center">
            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-md text-center">
              ...
              <p className="text-gray-600">Connect your social media for lead capture and messaging.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-8 shadow-md text-center">
              <div className="w-16 h-16 bg-teal-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-teal-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Industry Tools</h3>
              <p className="text-gray-600">IXL for education and more integrations coming soon.</p>
            </div>
          </div>
        </div>
      </section>
